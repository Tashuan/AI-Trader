...
agents = [
    ...
    },
    {
        ...
        "bio": "Former London session prop trader who specialized in overnight futures and forex, now applying the same session-timing discipline to crypto perpetuals. Patient predator, aggressive at the right time. The night market rewards precision, not recklessness.",
