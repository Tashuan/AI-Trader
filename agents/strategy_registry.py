    ...
    "scalp_4step": {
        ...
        "strategy_fields": {
            "exit_rules": {
                ...
                "trailing_sl_pct": _field("Trailing SL %", "number", minimum=0, maximum=10, default=0.4),
                "trailing_activation_pct": _field("Trailing Activation %", "number", minimum=0, maximum=10, default=0.5),
                ...
                "reentry_cooldown_cycles": _field("Reentry Cooldown Cycles", "number", minimum=0, maximum=20, default=3),
                "default_rsi": _field("Default RSI (no data)", "number", minimum=0, maximum=100, default=50),
            },
            "entry_criteria": {
            ...
            "position_sizing": {
                ...
                "consecutive_loss_threshold": _field("Consecutive Loss Threshold", "number", minimum=1, maximum=20, default=3),
                "consecutive_loss_size_cut_pct": _field("Consecutive Loss Size Cut %", "number", minimum=0, maximum=100, default=50),
                "final_stretch_threshold_pct": _field("Final Stretch Threshold %", "number", minimum=50, maximum=100, default=80.0),
            },
            "timeframes": {
            ...
            "discovery": {
                ...
                "scanner_universe": _field("Scanner Universe", "list", default=[]),
                "fallback_shortlist": _field("Fallback Shortlist", "list", default=[]),
                "scanner_interval": _field("Scanner Interval", "enum", choices=["1m", "5m", "15m"], default="5m"),
                "scanner_lookback_bars": _field("Scanner Lookback Bars", "number", minimum=10, maximum=500, default=50),
                "scanner_min_bars": _field("Scanner Min Bars", "number", minimum=5, maximum=100, default=20),
                "scanner_vol_lookback_bars": _field("Scanner Vol Lookback Bars", "number", minimum=5, maximum=100, default=20),
                "news_limit": _field("News Limit", "number", minimum=1, maximum=200, default=50),
                "news_process_limit": _field("News Process Limit", "number", minimum=1, maximum=200, default=50),
                "news_max_ticker_length": _field("News Max Ticker Length", "number", minimum=1, maximum=10, default=5),
                "news_max_symbols": _field("News Max Symbols", "number", minimum=1, maximum=100, default=20),
            },
            "order": {
                ...
                "sl_atr_multiple": _field("SL ATR Multiple", "number", minimum=0.1, maximum=5, default=1.5),
                "tp_atr_multiple": _field("TP ATR Multiple", "number", minimum=0.1, maximum=10, default=2.5),
                "market_type": _field("Market Type", "text", default="us-stock"),
                "order_type": _field("Order Type", "text", default="stop_limit"),
                "price_decimals": _field("Price Decimals", "number", minimum=0, maximum=10, default=6),
                "default_stop_distance_pct": _field("Default Stop Distance %", "number", minimum=0.1, maximum=20, default=1.0),
            },
            "indicators": {
                "rsi_period": _field("RSI Period", "number", minimum=2, maximum=50, default=14),
                "rsi_bullish": _field("RSI Bullish", "number", minimum=0, maximum=100, default=55),
            ...
            "breakout_detection": {
                "approaching_threshold_pct": _field("Approaching Threshold %", "number", minimum=0, maximum=10, default=0.5),
                "consolidation_threshold_pct": _field("Consolidation Threshold %", "number", minimum=0, maximum=10, default=1.0),
            },
            "pattern_detection": {
                "min_bars": _field("Min Bars for Pattern", "number", minimum=5, maximum=100, default=20),
                "consolidation_lookback": _field("Consolidation Lookback", "number", minimum=1, maximum=20, default=3),
                "range_breakout_confidence": _field("Range Breakout Confidence", "number", minimum=0, maximum=1, default=0.7),
                "flag_min_bars": _field("Flag Min Bars", "number", minimum=5, maximum=50, default=15),
                "flag_strong_move_bars": _field("Flag Strong Move Bars", "number", minimum=1, maximum=20, default=5),
                "flag_consolidation_bars": _field("Flag Consolidation Bars", "number", minimum=1, maximum=20, default=10),
                "flag_min_move_pct": _field("Flag Min Move %", "number", minimum=0, maximum=20, default=1.5),
                "flag_max_consolidation_range_pct": _field("Flag Max Cons Range %", "number", minimum=0, maximum=20, default=1.0),
                "flag_confidence": _field("Flag Confidence", "number", minimum=0, maximum=1, default=0.6),
                "wedge_min_bars": _field("Wedge Min Bars", "number", minimum=5, maximum=100, default=20),
                "wedge_lookback": _field("Wedge Lookback", "number", minimum=5, maximum=100, default=20),
                "wedge_confidence": _field("Wedge Confidence", "number", minimum=0, maximum=1, default=0.5),
            },
            "liquidity_scoring": {
                "avg_bars": _field("Avg Bars for Liquidity", "number", minimum=1, maximum=100, default=20),
                "spread_weight": _field("Spread Weight", "number", minimum=0, maximum=1, default=0.4),
                "depth_weight": _field("Depth Weight", "number", minimum=0, maximum=1, default=0.3),
                "volume_weight": _field("Volume Weight", "number", minimum=0, maximum=1, default=0.3),
                "good_threshold": _field("Good Threshold", "number", minimum=0, maximum=1, default=0.6),
                "marginal_threshold": _field("Marginal Threshold", "number", minimum=0, maximum=1, default=0.3),
            },
            "trend_detection": {
                "rsi_bullish": _field("Trend RSI Bullish", "number", minimum=0, maximum=100, default=55),
                "rsi_bearish": _field("Trend RSI Bearish", "number", minimum=0, maximum=100, default=45),
                "max_signals": _field("Max Trend Signals", "number", minimum=1, maximum=10, default=4),
            },
            "scoring_weights": {
                "confluence_weight": _field("Confluence Weight", "number", minimum=0, maximum=1, default=0.30),
                "level_alignment_weight": _field("Level Alignment Weight", "number", minimum=0, maximum=1, default=0.25),
                "pattern_weight": _field("Pattern Weight", "number", minimum=0, maximum=1, default=0.20),
                "liquidity_weight": _field("Liquidity Weight", "number", minimum=0, maximum=1, default=0.15),
                "volume_momentum_weight": _field("Volume Momentum Weight", "number", minimum=0, maximum=1, default=0.10),
            },
            "scoring_thresholds": {
                "min_qualification_score": _field("Min Qualification Score", "number", minimum=0, maximum=10, default=4.0),
                "fib_near_threshold_pct": _field("Fib Near Threshold %", "number", minimum=0, maximum=10, default=0.5),
                "fib_medium_threshold_pct": _field("Fib Medium Threshold %", "number", minimum=0, maximum=10, default=1.0),
                "fib_near_score": _field("Fib Near Score", "number", minimum=0, maximum=1, default=0.7),
                "fib_medium_score": _field("Fib Medium Score", "number", minimum=0, maximum=1, default=0.3),
                "level_alignment_ready": _field("Level Alignment Ready", "number", minimum=0, maximum=1, default=1.0),
                "level_alignment_approaching": _field("Level Alignment Approaching", "number", minimum=0, maximum=1, default=0.5),
                "confluence_max": _field("Confluence Max", "number", minimum=1, maximum=10, default=2.0),
                "score_scale": _field("Score Scale", "number", minimum=1, maximum=100, default=10.0),
            },
            "technical": {
                "atr_fallback_pct": _field("ATR Fallback %", "number", minimum=0, maximum=5, default=0.2),
                "min_confluence_for_agreement": _field("Min Confluence for Agreement", "number", minimum=1, maximum=10, default=2),
                "swing_window": _field("Swing Window", "number", minimum=1, maximum=10, default=2),
                "swing_min_bars": _field("Swing Min Bars", "number", minimum=3, maximum=50, default=5),
                "min_bars_precompute": _field("Min Bars Precompute", "number", minimum=5, maximum=100, default=30),
                "sr_strength_normalization": _field("S/R Strength Normalization", "number", minimum=1, maximum=100, default=10.0),
            },
            "data_fetch": {
                "intraday_period": _field("Intraday Period", "enum", choices=["1d", "5d", "1mo"], default="5d"),
                "daily_period": _field("Daily Period", "enum", choices=["1mo", "3mo", "6mo", "1y"], default="3mo"),
                "default_period": _field("Default Period", "enum", choices=["5d", "1mo", "3mo"], default="1mo"),
                "intraday_min_bars": _field("Intraday Min Bars", "number", minimum=5, maximum=200, default=30),
                "daily_min_bars": _field("Daily Min Bars", "number", minimum=5, maximum=200, default=10),
                "entry_min_bars": _field("Entry Min Bars", "number", minimum=5, maximum=200, default=30),
            },
        },
    },
}
